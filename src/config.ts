...
const envSchema = z.object({
  ...
  DEFAULT_PROVIDER: z.enum(["openai", "gemini", "groq", "local"]).default("gemini"),
  DIRECT_CHAT_PROVIDER: z.enum(["openai", "gemini", "groq", "local"]).default("groq"),
  ...
  CODEX_AUTOMATION_ENABLED: z.coerce.boolean().default(true),
